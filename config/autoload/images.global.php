...
return [
    'images' => [
        ...
        'course-int-mobile' => [
            KEY_PNG => [
                [WIDTH => 513, HEIGHT => 441, QUALITY => 100], /* изображения онлайн курса в рекомендуемых, и детальной информации о курсе s1 513x441 */
                [WIDTH => 408, HEIGHT => 351, QUALITY => 100], /* изображения онлайн курса в списках курсов s2 408x351 */
                [WIDTH => 120, HEIGHT => 120, QUALITY => 100], /* круглое изображение онлайн курсов s3 120x120 */
            ]
        ],
        'b2b-company' => [
            KEY_DEFAULT => [

    ...
    'images' => [
        'translation' => [
            'default' => [
                ...
                [WIDTH => 240, HEIGHT => 168], // размер для карточки слова
                [WIDTH => 256, HEIGHT => 190], // размер для тренировки для веб версии
                [WIDTH => 600, HEIGHT => 432], // размер для тренировки для мобильной версии
            ],
        ],
        'word-set' => [
            'default' => [
